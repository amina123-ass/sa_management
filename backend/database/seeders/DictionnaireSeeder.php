...
class DictionnaireSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $communes = [
            ...
            ['code' => 'imouzer_kander', 'nom' => 'Imouzer Kander', 'is_active' => true],
            ['code' => 'Bhalil', 'nom' => 'Bhalil', 'is_active' => true],
            ['code' => 'Ait_Sbaa_lajrouf', 'nom' => 'Ait Sbaa lajrouf', 'is_active' => true],
            ['code' => 'Oulad_Mkoudou', 'nom' => 'Oulad Mkoudou', 'is_active' => true],
            ['code' => ' Mternagha', 'nom' => ' Mternagha', 'is_active' => true],
            ['code' => 'Ain_timgnay', 'nom' => 'Ain timgnay', 'is_active' => true],
            ['code' => 'Sidi_Lahcen', 'nom' => 'Sidi Lahcen', 'is_active' => true],
            ['code' => ' Tazouta', 'nom' => ' Tazouta', 'is_active' => true],
            ['code' => 'Ribat_Lkhir', 'nom' => 'Ribat Lkhir', 'is_active' => true],
            ['code' => 'Ain_chegag', 'nom' => 'Ain chegag', 'is_active' => true],
            ['code' => ' Azzaba', 'nom' => ' Azzaba', 'is_active' => true],
            ['code' => ' Aghbalou_akourar', 'nom' => 'Aghbalou akourar', 'is_active' => true],
            ['code' => ' Sefrou', 'nom' => ' Sefrou', 'is_active' => true],
            ['code' => ' Laanoucer', 'nom' => ' Laanoucer', 'is_active' => true],
            ['code' => ' Sidi_khiar', 'nom' => ' Sidi khiar', 'is_active' => true],
            ['code' => 'Ras_Tbouda', 'nom' => 'Ras Tbouda', 'is_active' => true],
            ['code' => ' Bir_Tam_Tam', 'nom' => ' Bir Tam Tam', 'is_active' => true],
        ];
